 ...
 * @Block(
 *   id = "ipu_node_block",
 *   admin_label = @Translation("IPU content block"),
...
class IpuNodeBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a IpuNodeBlock instance.
   *
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['nid'] = [
      ...
      '#target_type' => 'node',
      '#selection_handler' => 'default', //'ipu_map:node',
    ...
    $form['link_text'] = [
      '#title' => t('Link text'),
      '#description' => t('The text you want to display on the button. Max 40 characters'),
      '#type' => 'textfield',
      '#default_value' => 'More',
      '#size' => 30,
      '#maxlen' => 40,
